  ...
  return (
    <ContentPageLayout>
      ...
      <div className="mx-3 my-8">
        ...
        <p className="text-primary-content/50 mb-4">
        ...
        <div className="flex items-center mb-4 gap-2">
          ...
          />
          <button className="flex-1 btn btn-info">
            验证
          </button>
        </div>

        <p className="text-base-content/50 mb-2">如果你还没有预付款码，可以直接加大娟小红书或者微信（微信麻烦备注：亲子英语）。期待和你直接交流 <span className="text-base-content">😊</span> </p>

        {/* 二维码 */}
        <div className="flex justify-between gap-8 mt-6 sm:mx-10">
          <div className="flex flex-col items-center">
            <img src="/qrcode-xhs.png" alt="小红书二维码" className="w-32 h-32 mb-2" />
            <span className="text-base-content/50 text-sm">小红书</span>
          </div>
          <div className="flex flex-col items-center">
            <img src="/qrcode-wechat.png" alt="微信二维码" className="w-32 h-32 mb-2" />
            <span className="text-base-content/50 text-sm">微信</span>
          </div>
        </div>
      </div>
  ...
  return (
    <>
      ...
      >
        ...
        {/* 3. 使用百分比定位文字，确保位置固定 */}
        <div className='absolute text-base-content/90 z-10 text-center text-base-100 top-[10%] right-[13%] sm:top-[25%] sm:right-[15%] '>
